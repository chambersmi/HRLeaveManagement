...
namespace HRLeaveManagement.Persistence.Migrations
{
    ...
    [Migration("20251230153535_InitialCreate")]
            ...
            modelBuilder.Entity("HRLeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2025, 12, 30, 10, 35, 33, 576, DateTimeKind.Local).AddTicks(7904),
                            DateModified = new DateTime(2025, 12, 30, 10, 35, 33, 576, DateTimeKind.Local).AddTicks(7948),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
